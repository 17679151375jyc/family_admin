<!--选择出警人员-->
<template>
  <Modal title="设为误报" v-model.trim="visible" :mask-closable="false">
    <Form ref="form" :model="form" :rules="rules" :label-width="100">
      <FormItem prop="remarks" label="误报备注">
        <Input v-model="form.remarks" type="textarea" :rows="4" placeholder="请填写误报备注" />
      </FormItem>
    </Form>
    <div slot="footer">
...
<script>
import { alertMistake } from "@/api/messageManage";
export default {
  props: {
    value: {
      type: Boolean,
