<template>
  <Modal title="添加" v-model.trim="visible" :mask-closable="false">
    <Form ref="form" :model="form" :rules="rules" :label-width="100">
      ...
      <FormItem prop="originPrice" label="本金">
        <InputNumber v-model="form.originPrice" style="width:200px;"></InputNumber>
      </FormItem>
      <FormItem prop="businessValue" label="商家价值">
        <InputNumber v-model="form.businessValue" style="width:166px;"></InputNumber>
        <Tag
          color="success"
      ...
      <FormItem prop="enoughPrice" label="满多少元可用">
        <InputNumber v-model="form.enoughPrice" style="width:200px;"></InputNumber>
      </FormItem>
      ...
      <FormItem prop="stock" label="库存">
        <InputNumber v-model="form.stock" style="width:200px;"></InputNumber>
      </FormItem>
      <FormItem prop="restrictionNumber" label="限购数量">
        <InputNumber v-model="form.restrictionNumber" style="width:200px;"></InputNumber>
      </FormItem>
...
<script>
import { addCoupon, getBusinessList } from "@/api/dataManage";
export default {
  props: {
    value: {
      type: Boolean,
    ...
    submit() {
      this.$refs["form"].validate(async valid => {
        if (valid) {
          ...
          let { effectiveTime, businessValue, type } = this.form;
